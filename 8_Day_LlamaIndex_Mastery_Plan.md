...
| **Day 2** | **Indexing & Vector Stores** | Topics 4-5. `VectorStoreIndex`, Node Management, and persistence in DBs like Pinecone, Qdrant, Chroma, and PGVector. | 📂 Present Locally (To be uploaded) |
...
| **Day 4** | **Retrieval & Re-ranking** | Topics 8-9. Advanced retrieval (BM25, Hybrid), Streaming responses, and quality improvement via Rerankers (Cohere, BGE). | 📂 Present Locally (To be uploaded) |
| **Day 5** | **Chat Engines & Data Extraction** | Topics 10-11. Building multi-turn chat interfaces with memory and extracting structured pydantic data from documents. | 📂 Present Locally (To be uploaded) |
